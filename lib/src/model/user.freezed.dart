...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, account: $account, profileImageUrls: $profileImageUrls, isFollowed: $isFollowed)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, account, profileImageUrls, isFollowed);
...
abstract class _User implements User {
  factory _User(
      ...
      final bool? isFollowed}) = _$UserImpl;
